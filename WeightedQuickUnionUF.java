 ...
 * <em>n</em>–1. The <em>is-connected-to</em> relation must be an
 ...
 * two sites are in the same component if and only if they are connected. Both sites and components
 * are identified with integers between 0 and
 * <em>n</em>–1.
 ...
 * connection between the two sites <em>p</em> and <em>q</em>. If <em>p</em> and <em>q</em> are in
 * different components, then it replaces these two components with a new component that is the
 * union of the two.
 ...
 * returns true if both <em>p</em> and <em>q</em> are in the same component, and false otherwise.
 ...
 * For alternate implementations of the same API, see {@link UF}, {@link QuickFindUF}, and {@link
 * QuickUnionUF}.
 *
 * <p>
